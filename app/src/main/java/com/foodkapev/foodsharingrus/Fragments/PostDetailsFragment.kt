...
//import com.example.foodsharingrus.Adapter.PostDetailsAdapter
...
import com.foodkapev.foodsharingrus.Adapter.PostDetailsAdapter
    ...
    private fun retrievePosts() {
        ...
        postsRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                view?.post_title_bar!!.text = post.getTitle()
            }
